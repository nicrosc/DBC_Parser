...
namespace ZadatakJuric.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250625145815_DBCEntity")]
    partial class DBCEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZadatakJuric.Domain.Entities.DBC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZadatakJuric.Domain.Entities.Attribute", b =>
                {
                    b.HasOne("ZadatakJuric.Domain.Entities.DBC", "DBC")
                        .WithMany("Attributes")
                        .HasForeignKey("DBCId")
